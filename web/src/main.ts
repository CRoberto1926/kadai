...
} from './app/monitor/components/task-priority-report/task-priority-report.component';
import {
  TaskPriorityReportFilterComponent
} from './app/monitor/components/task-priority-report-filter/task-priority-report-filter.component';
import {CanvasComponent} from './app/monitor/components/canvas/canvas.component';
import {
  TimestampReportComponent
} from './app/monitor/components/timestamp-report/timestamp-report.component';
import {
  WorkbasketReportComponent
} from './app/monitor/components/workbasket-report/workbasket-report.component';
import {
  WorkbasketReportPlannedDateComponent
} from './app/monitor/components/workbasket-report-planned-date/workbasket-report-planned-date.component';
import {
  WorkbasketReportDueDateComponent
} from './app/monitor/components/workbasket-report-due-date/workbasket-report-due-date.component';
import {TaskReportComponent} from './app/monitor/components/task-report/task-report.component';
import {
  ClassificationReportComponent
} from './app/monitor/components/classification-report/classification-report.component';
...
} from './app/workplace/components/task-list-toolbar/task-list-toolbar.component';
...
} from './app/workplace/components/task-information/task-information.component';
import {
  TaskAttributeValueComponent
} from './app/workplace/components/task-attribute-value/task-attribute-value.component';
import {
  TaskCustomFieldsComponent
} from './app/workplace/components/task-custom-fields/task-custom-fields.component';
import {
  TaskProcessingComponent
} from './app/workplace/components/task-processing/task-processing.component';
import {
  TaskStatusDetailsComponent
} from './app/workplace/components/task-status-details/task-status-details.component';
...
} from './app/shared/components/progress-spinner/progress-spinner.component';
import {DialogPopUpComponent} from './app/shared/components/popup/dialog-pop-up.component';
import {
  WorkbasketFilterComponent
} from './app/shared/components/workbasket-filter/workbasket-filter.component';
...
} from './app/shared/services/classifications/classifications.service';
...
} from './app/history/task-history-query/task-history-query.component';
import {InfiniteScrollModule} from 'ngx-infinite-scroll';
import {ScrollingModule} from '@angular/cdk/scrolling';
import {
  WorkbasketOverviewComponent
} from './app/administration/components/workbasket-overview/workbasket-overview.component';
import {
  WorkbasketListComponent
} from './app/administration/components/workbasket-list/workbasket-list.component';
import {
  WorkbasketListToolbarComponent
} from './app/administration/components/workbasket-list-toolbar/workbasket-list-toolbar.component';
import {
  WorkbasketAccessItemsComponent
} from './app/administration/components/workbasket-access-items/workbasket-access-items.component';
import {
  WorkbasketDetailsComponent
} from './app/administration/components/workbasket-details/workbasket-details.component';
import {
  WorkbasketInformationComponent
} from './app/administration/components/workbasket-information/workbasket-information.component';
import {
  WorkbasketDistributionTargetsComponent
} from './app/administration/components/workbasket-distribution-targets/workbasket-distribution-targets.component';
import {
  WorkbasketDistributionTargetsListComponent
} from './app/administration/components/workbasket-distribution-targets-list/workbasket-distribution-targets-list.component';
import {
  ClassificationOverviewComponent
} from './app/administration/components/classification-overview/classification-overview.component';
import {
  ClassificationListComponent
} from './app/administration/components/classification-list/classification-list.component';
import {
  ClassificationTypesSelectorComponent
} from './app/administration/components/classification-types-selector/classification-types-selector.component';
import {
  ClassificationDetailsComponent
} from './app/administration/components/classification-details/classification-details.component';
import {
  ImportExportComponent
} from './app/administration/components/import-export/import-export.component';
import {
  AccessItemsManagementComponent
} from './app/administration/components/access-items-management/access-items-management.component';
import {
  AdministrationOverviewComponent
} from './app/administration/components/administration-overview/administration-overview.component';
import {MatRippleModule} from '@angular/material/core';
import {
  ClassificationDefinitionService
} from './app/administration/services/classification-definition.service';
import {
  WorkbasketDefinitionService
} from './app/administration/services/workbasket-definition.service';
import {ImportExportService} from './app/administration/services/import-export.service';
import {
  RoutingUploadComponent
} from '@task-routing/components/routing-upload/routing-upload.component';
...
} from '@task/components/task-details-container/task-details-container.component';
...
bootstrapApplication(AppComponent, {
  providers: [
    ...
    ]), ...([NavBarComponent, UserInformationComponent, NoAccessComponent, SidenavListComponent])),
    ...([
      WindowRefService,
      DomainService,
      RequestInProgressService,
